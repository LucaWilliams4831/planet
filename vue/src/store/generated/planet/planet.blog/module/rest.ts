...
export interface BlogQueryAllSendPostResponse {
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/planet/blog/send_post
   */
  querySendPostAll = (
    query?: {
      "pagination.key"?: string;
    ...
    this.request<BlogQueryAllSendPostResponse, RpcStatus>({
      path: `/planet/blog/send_post`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
